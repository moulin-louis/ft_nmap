...
static void tcp_craft_payload(struct tcphdr* tcp_hdr, const uint16_t port) {
...
static int32_t tcp_send_probe(const NMAP_UltraScan* us, t_port* port, struct in_addr ip_dest, struct in_addr ip_src,
                              uint16_t tcp_flag) {
